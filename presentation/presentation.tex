...
\begin{frame}{Projektübersicht}
  \centering
  \includegraphics[width=0.95\textwidth,height=0.8\textheight,keepaspectratio]{images/01_gesamtarchitektur.png}
\end{frame}

\begin{frame}{Repository-Struktur}
  \centering
  \includegraphics[width=0.95\textwidth,height=0.82\textheight,keepaspectratio]{images/08_projektstruktur.png}
\end{frame}
...
\begin{frame}{Attack Kill Chain -- Übersicht}
  \centering
  \includegraphics[width=0.98\textwidth,height=0.78\textheight,keepaspectratio]{images/02_attack_kill_chain.png}
\end{frame}
...
\begin{frame}{Phase 2: Agent Architektur}
  \centering
  \includegraphics[width=0.95\textwidth,height=0.82\textheight,keepaspectratio]{images/03_rust_agent.png}
\end{frame}
...
\begin{frame}{Phase 3: C2 Kommunikation}
  \centering
  \includegraphics[width=0.95\textwidth,height=0.82\textheight,keepaspectratio]{images/07_c2_kommunikation.png}
\end{frame}
...
\begin{frame}{Phase 4: Verschlüsselungsprozess}
  \centering
  \includegraphics[width=0.95\textwidth,height=0.82\textheight,keepaspectratio]{images/06_verschluesselung.png}
\end{frame}
...
\begin{frame}{Die Angriffskette}
  ...
  \begin{figure}
    ...
    \includegraphics[width=\textwidth]{images/Angriffskette.png}
  \end{figure}
