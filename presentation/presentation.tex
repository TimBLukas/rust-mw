...
% Ramsomware as a buisness

\begin{frame}{Warum die Bedrohung bleibt: Die Ökonomie}
  \textbf{Ransomware-as-a-Service (RaaS)} ist eine hochprofessionelle Schattenwirtschaft mit Milliardenumsätzen. Die Arbeitsteilung ähnelt legalen Konzernen:
  \vspace{0.5em}
  ...
  \begin{columns}[t]
    \begin{column}{0.33\textwidth}
      \begin{block}{1. Access Provider}
        \scriptsize
        Spezialisten ("Türöffner"), die Zugänge zu Netzwerken potenzieller Opfer verkaufen.
      \end{block}
    \end{column}
    \begin{column}{0.33\textwidth}
      \begin{block}{2. RaaS Provider}
        \scriptsize
        Entwickler der Malware. Bieten Schadsoftware, C2-Infrastruktur und Verhandlungssupport gegen Miete/Provision an.
      \end{block}
    \end{column}
    \begin{column}{0.33\textwidth}
      \begin{block}{3. Affiliates}
        \scriptsize
        Kaufen Zugänge, mieten die Malware und führen den eigentlichen Angriff beim Opfer durch.
      \end{block}
    \end{column}
  \end{columns}
\end{frame}
